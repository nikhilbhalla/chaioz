  ...
  return (
    <div className="pt-28 pb-24 max-w-7xl mx-auto px-6 sm:px-8" data-testid="community-page">
      <div className="mb-12">
        ...
        <h1 className="font-serif text-5xl md:text-6xl text-chaioz-teal mt-2">Community & Events.</h1>
      ...
      <section className="grid md:grid-cols-3 gap-5">
        {events.map((e, i) => (
          <article key={i} data-testid={`event-${i}`} className="border border-chaioz-line bg-white rounded-2xl overflow-hidden group">
            ...
            <div className="p-6">
              ...
              <h3 className="font-serif text-2xl text-chaioz-teal mt-2">{e.title}</h3>
              <p className="text-sm text-chaioz-teal/70 mt-2 leading-relaxed">{e.desc}</p>
            </div>
          </article>
        ))}
      </section>
      ...
      <section className="mt-20 border border-chaioz-line bg-white rounded-3xl p-10 grid md:grid-cols-2 gap-8" data-testid="visit-section">
        <div>
          <span className="text-xs uppercase tracking-[0.3em] text-chaioz-saffron">Visit us</span>
          <h2 className="font-serif text-4xl text-chaioz-teal mt-2">North Adelaide.</h2>
          <p className="text-chaioz-teal/70 mt-3">Slip down O'Connell Street and look for the saffron sign.</p>
          <ul className="mt-6 space-y-3 text-chaioz-teal/80">
